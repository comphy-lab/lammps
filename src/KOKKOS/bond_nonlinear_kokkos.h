...
#ifdef BOND_CLASS
// clang-format off
BondStyle(nonlinear/kk,BondNonlinearKokkos<LMPDeviceType>);
BondStyle(nonlinear/kk/device,BondNonlinearKokkos<LMPDeviceType>);
BondStyle(nonlinear/kk/host,BondNonlinearKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_BOND_NONLINEAR_KOKKOS_H
#define LMP_BOND_NONLINEAR_KOKKOS_H
...
struct TagBondNonlinearCompute{};

template<class DeviceType>
class BondNonlinearKokkos : public BondNonlinear {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  BondNonlinearKokkos(class LAMMPS *);
  ~BondNonlinearKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagBondNonlinearCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagBondNonlinearCompute<NEWTON_BOND,EVFLAG>, const int&) const;
