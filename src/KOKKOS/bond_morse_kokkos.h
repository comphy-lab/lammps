...
#ifdef BOND_CLASS
// clang-format off
BondStyle(morse/kk,BondMorseKokkos<LMPDeviceType>);
BondStyle(morse/kk/device,BondMorseKokkos<LMPDeviceType>);
BondStyle(morse/kk/host,BondMorseKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_BOND_MORSE_KOKKOS_H
#define LMP_BOND_MORSE_KOKKOS_H
...
class BondMorseKokkos : public BondMorse {
 public:
  ...
  BondMorseKokkos(class LAMMPS *);
  ~BondMorseKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagBondMorseCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagBondMorseCompute<NEWTON_BOND,EVFLAG>, const int&) const;
...
// NOLINTNEXTLINE
 ...
 protected:
  ...
  DAT::tdual_kkfloat_1d k_d0;
  DAT::tdual_kkfloat_1d k_alpha;
  DAT::tdual_kkfloat_1d k_r0;

  typename AT::t_kkfloat_1d d_d0;
