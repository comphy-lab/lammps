...
#include "pair_lj_cut_coul_wolf_kokkos.h"
...
PairLJCutCoulWolfKokkos<DeviceType>::PairLJCutCoulWolfKokkos(LAMMPS *lmp)
  : PairLJCutCoulWolf(lmp)
{
  respa_enable = 0;
...
template<class DeviceType>
PairLJCutCoulWolfKokkos<DeviceType>::~PairLJCutCoulWolfKokkos()
{
  if (copymode) return;
...
template<class DeviceType>
void PairLJCutCoulWolfKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  ev = pair_compute<PairLJCutCoulWolfKokkos<DeviceType>,void>
...
KK_FLOAT PairLJCutCoulWolfKokkos<DeviceType>::
...
template<class DeviceType>
void PairLJCutCoulWolfKokkos<DeviceType>::allocate()
{
  PairLJCutCoulWolf::allocate();
  ...
  k_params = Kokkos::DualView<params_lj_coul**,Kokkos::LayoutRight,DeviceType>(
    "PairLJCutCoulWolf::params",n+1,n+1);
...
template<class DeviceType>
void PairLJCutCoulWolfKokkos<DeviceType>::init_style()
{
...
template<class DeviceType>
double PairLJCutCoulWolfKokkos<DeviceType>::init_one(int i, int j)
{
...
namespace LAMMPS_NS {
template class PairLJCutCoulWolfKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class PairLJCutCoulWolfKokkos<LMPHostType>;
#endif
}
