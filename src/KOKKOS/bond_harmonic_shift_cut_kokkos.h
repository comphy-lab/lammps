...
#ifdef BOND_CLASS
// clang-format off
BondStyle(harmonic/shift/cut/kk,BondHarmonicShiftCutKokkos<LMPDeviceType>);
BondStyle(harmonic/shift/cut/kk/device,BondHarmonicShiftCutKokkos<LMPDeviceType>);
BondStyle(harmonic/shift/cut/kk/host,BondHarmonicShiftCutKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_BOND_HARMONIC_SHIFT_CUT_KOKKOS_H
#define LMP_BOND_HARMONIC_SHIFT_CUT_KOKKOS_H
...
struct TagBondHarmonicShiftCutCompute{};

template<class DeviceType>
class BondHarmonicShiftCutKokkos : public BondHarmonicShiftCut {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  BondHarmonicShiftCutKokkos(class LAMMPS *);
  ~BondHarmonicShiftCutKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagBondHarmonicShiftCutCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagBondHarmonicShiftCutCompute<NEWTON_BOND,EVFLAG>, const int&) const;
