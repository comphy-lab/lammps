...
if [ $# -eq 1 ] && [ $1 = run ]; then
  ...
  numdiff -r $TOL e_test.1.dat e_old.1.dat
  if [ $? -eq 0 ];
  then 
  ...
  numdiff -r $TOL e_test.4.dat e_old.4.dat
  if [ $? -eq 0 ];
  then 
  ...
  numdiff -r $TOL e_test.4type.1.dat e_old.4type.1.dat
  if [ $? -eq 0 ];
  then 
  ...
  numdiff -r $TOL e_test.4type.4.dat e_old.4type.4.dat
  if [ $? -eq 0 ];
  then 
  ...
  numdiff -r $TOL e_test.8type.1.dat e_old.8type.1.dat
  if [ $? -eq 0 ];
  then 
  ...
  numdiff -r $TOL e_test.8type.4.dat e_old.8type.4.dat
  if [ $? -eq 0 ];
  then 
